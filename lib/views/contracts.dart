...
var moreServicesDetailsItems = [
  ...
  MoreServicesDetails("الوسيلة","صيدلية","الخرطوم - العربي - قرب شارع الحوادث", "assets/images/136949.jpg"),
  ...
  MoreServicesDetails("ابن سينا","مستشفي","الخرطوم - العربي - قرب شارع الحوادث", "assets/images/136949.jpg"),
  MoreServicesDetails("المتكامل","مركز صحي","الخرطوم - العربي - قرب شارع الحوادث", "assets/images/136949.jpg"),
 MoreServicesDetails("الرعاية الخاصة","معمل","الخرطوم - العربي - قرب شارع الحوادث", "assets/images/136949.jpg"),
          ...
          children: [
                  ...
                  children: [
                    Container(
                      ...
                      child:  Row(
                        children:  [
                          ...
                          Container(child: Icon(Icons.volunteer_activism , color: Color(
                              0xff0a0a0a).withOpacity(0.65),),
                            height: 40,
                            width: 40,
                          ),
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        onSubmitted: (value){
                          setState(() {
                            listToFill = moreServicesDetailsItems.where((element) => element.title.contains(value)).toList();
            ...
            Padding(
              ...
              child: Container(
                ...
                child: listToFill.length == 0? (
                Text('لايوجد نتائج للبحث',style: (TextStyle(
                  color: Colors.red
                )
                    ...
                    return  Container(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => ServicesBodyDetails(listToFill[index]),
                            ),
                          );
                        },
                        hoverColor: PColor,
                        leading: Icon(Icons.home_work_outlined ,color: PColor,),
                        title: Text(listToFill[index].title),
                        subtitle: Text(listToFill[index].category),
